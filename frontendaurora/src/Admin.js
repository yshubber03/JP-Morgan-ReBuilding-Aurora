    ...
    return (
        <>
            ...
            <form onSubmit={submitForm}>
                <h3>Name of Event</h3>
                <input style = {{padding: 15, width: 350, height: 20}} name="name"/> 
                <h3>Date of Event</h3>
                <input style = {{padding: 15, width: 350, height: 20}} value={props.eventDate.toDateString()} name="date"/> 
                <h3>Time of Event</h3>
                <input style = {{padding: 15, width: 350, height: 20}} name="time"/>
                <h3>Number of Volunteers Needed</h3>
                <input style = {{padding: 15, width: 350, height: 20}} name="volunteers"/>
                <br/>
